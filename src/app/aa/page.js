...
export const metadata = {
    ...
    keywords: 'A∴A∴, Soror Estai, Jane Wolfe, Soror Meral, Phyllis Seckler, One Start in Site, Lineages A∴A∴, Book of the Law, Liber al vel Legis, Liber L, thelema, a∴a∴ website, a a order, aa order, aa crowley, a a aleister crowley, aa thelema, a∴a∴, thelemic temple, thelema website, temple of thelema, college of thelema',
    alternates: {
      canonical: '/aa'
    },
    openGraph: {
                ...
                <aside>
                    <div className="wrapper--sticky">
                        ...
                        <ul className="list">
                            ...
                            <li>
                                <a aria-label="Book of the Law" href="aa/bookofthelaw">Liber Al vel Legis</a>
                            </li>
                        </ul>
                    </div>
                </aside>
