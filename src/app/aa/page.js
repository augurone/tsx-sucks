                    ...
                    <div className="wrapper--sticky">
                        ...
                        <ul className="list">
                            ...
                            <li>
                                ...
                                <a href="#article--LiberLIII"> III</a><br/>
                ...
                <section className="pb-8">
                    ...
                    <article className="article article--fullWidth">
                        ...
                        <section className="wrapper-text--columns">
                            ...
                            <p><strong>A&there4;A&there4;</strong> is the one true and invisible Order which has operated under various names and guises throughout history to guide the spiritual evolution of humanity. The goals of the <strong>A&there4;A&there4;</strong> are those which have motivated spiritual exploration and religious inquiry throughout human history. Its methods are those of science; its aims are those of religion.</p>
                            ...
                            <ul className="list list--flex list--thumbnails u-justify--evenly u-wrap">
                                <li>
                                    <div className="wrapper-img wrapper-img--med">
                                        <Image alt="Aleister Crowley—The Beast" width="62" height="62" src="/profile-crowley_aliester.jpg" style={{backgroundImage: 'url(/profile-crowley_aliester.jpg)'}} />
                                    </div>
                                ...
                                <li>
                                    <div className="wrapper-img wrapper-img--med">
                                        <Image alt="Jane Wolf—Soror Estai" width="62" height="62" src="/profile-wolf_jane.jpg" style={{backgroundImage: 'url(/profile-wolf_jane.jpg) ', backgroundPosition: ' 0 0'}}/>
                                    </div>
                                    <span className="text text--medium">
                                        Estai
                                    </span>
                                ...
                                <li>
                                    <div className="wrapper-img wrapper-img--med">
                                        <Image alt="Phyllis Secklern (Soror Meral)" width="62" height="62" src="/profile-seckler_phyllis.jpg" style={{backgroundImage: 'url(/profile-seckler_phyllis.jpg'}} />
                                    </div>
                                    <span className="text text--medium">
                                       Meral
                                    </span>
                                ...
                                <li>
                                    <div className="wrapper-img wrapper-img--med">
                                        <Image alt="James A. Eshleman—Prolocutor General" width="62" height="62" src="/profile-eshelman_jim.jpg" style={{backgroundImage: 'url(/profile-eshelman_jim.jpg)'}} />
                                    </div>
                                    <span className="text text--medium">
                                        Heru Aur
                                    </span>
                        ...
                        <section className="wrapper-text--columns">
                            <h3>Admission As A Probationer</h3>
                            <p>From its beginning, the <strong>A&there4;A&there4;</strong> philosophy supported the admission of any interested person soever into the instruction and practice of Scientific Illuminism. In other words — in the earliest years — anyone at all could write to the <strong>A&there4;A&there4;</strong> and request an interview with a Neophyte who &#40;all things proceeding agreeably to the applicant&#41; would admit the individual as a Probationer &#40;0=0 Grade&#41; forthwith.</p>
                            <p>Unfortunately, this complete &quote;open door&quote; policy resulted in a very high percentage of failures. By early 1912 it was found necessary to make a change in the admission requirements. It was thus ordered &quote;that every person wishing to become a Probationer of <strong>A&there4;A&there4;</strong> must first pass three months as a Student of the Mysteries.&quote; A specific study and testing curriculum was established for this Student period.</p>
                            <p>However, although Aleister Crowley inaugurated this Studentship in 1912, and gave examination in it as late as 1945 &#40;about two and a half years before his death&#41;. there is little evidence that he paid much attention to it, in that form, during the intervening 33 years. Instead, he tried numerous ways of preparing people to undertake the Probationer Grade of <strong>A&there4;A&there4;</strong>. He moved from one approach to the next, apparently adapting each to the needs of a particular student as best he could.</p>
                            <p>Many years ago, this same approach was adopted by the Soror Estai lineage. While each applicant is required to pass through a formal Student period, many avenues are accepted for accomplishing this. &#40;For clarity, we should mention that beginning with Probationer, the administration of the <strong>A&there4;A&there4;</strong> Grades is strictly by the criteria established by Aleister Crowley and George Cecil Jones. It is only in the Student, or preparatory, stage that such broad variation is practiced.&#41;</p>
                            <p>Any sincere aspirant seeking to affiliate with the <strong>A&there4;A&there4;</strong> as a Probationer may write: <a href="mailto:cancellarius@arcanum-arcanorum.org">Cancellarius, <strong>A&there4;A&there4;</strong></a></p>
                        </section>
                        <Image alt="The Seal of the AA" width="186" height="186" className="img-icon--xLarge" src="/seal_of_aa.png" />
