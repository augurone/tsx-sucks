...
export default function Page() {
    ...
    <body id="page--top" className='theme--Warmer'>
        <Navbar disableRoute='/college' h1='College of Thelema: The Standard in Thelemic Education' />
        <main>
            <aside>
                    ...
                    <ul className="list list--container">
                        <li className="card--large">
                            ...
                            <section>
                                ...
                                <EventCollection 
                                    qry="metadata.tags.sys.id[in]=losAngeles&skip=2"
                                    limit= "&limit=1"
                        ...
                        <li className="card--large">
                            ...
                            <section>
                                ...
                                <EventCollection 
                                    qry="metadata.tags.sys.id[in]=newYork&skip=1"
                                    limit= "&limit=1"
                                    order= "&order=-fields.dateAndTime" />
                            </section>
                        </li>
