...
export default async function Home() {
  return (
    <body className='index theme--Warmer'>
        <header className="background--solar">
                        ...
                        <ul className="list list--flex list--thumbnails u-justify--evenly">
                            ...
                            <li>
                                <div className="wrapper-img wrapper-img--med wrapper-img--square">
                                    <Image alt="Apply For Membership" width="62" height="62" src="/ennealeph.png" style={{backgroundImage: 'url(/ennealeph.png)', backgroundSize: '131%'}}/>
                                </div>
                                <span>Join TOT</span>
                ...
                <Link aria-label="A Modern Mystery School" className="mark link" href="#page--top" prefetch={true}>A Modern Mystery School</Link>
        </header>
        <main id="page--top">
            <aside>
                <div className="wrapper--sticky">
                    <h2>On This Page:</h2>
                    <ul className="list">
                        <li><a href="#page--top">A Modern Mystery School</a></li>
