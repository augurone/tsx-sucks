        ...
        <main>
            <aside>
                <div className="wrapper--sticky">
                    <h2>On This Page:</h2>
                    <ul className="list">
                        <li><a href="#page--top">Books</a></li>
                        <li><a href="#article--periodicals">Periodicals for Download</a></li>
                        <li><a href="#article--monographs">Monographs for Download</a></li>
                    </ul>
                </div>
            </aside>
            <section>
                ...
                <article id="page--top" className="article article--fullWidth">
                    <h3>Books</h3>
                    <figure className="card--book flex items-start gap-8 w-full pb-8">
                            <div className="flex flex-col items-start">
                                <Image width="220" height="293"alt="Pearls of Wishom: James A. Eshleman" src="/cover_Pearls-Eshelman.webp" style={{backgroundImage: 'url(/cover_Pearls-Eshelman.webp)'}} />
                                <aside>
                                    <hgroup>
                    ...
                    <figure className="card--book flex items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start order-1">
                                    <Image width="220" height="293"alt="The Mystical && Magical System of the AA: James A. Eshleman" src="/cover_MMAA-Eshelman.webp" style={{backgroundImage: 'url(/cover_MMAA-Eshelman.webp)'}} />
                                    <aside>
                                        <hgroup>
                    ...
                    <figure className="card--book flex items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start">
                                    <Image width="207" height="267" alt="Visions & Voices: James A. Eshleman" src="/cover_VV-Eshelman.webp"  style={{backgroundImage: 'url(/cover_VV-Eshelman.webp)'}} />
                                    <aside>
                                        <hgroup>
                    ...
                    <figure className="card--book flex items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start order-1">
                                <Image width="207" height="267" alt="776 & One half: James A. Eshleman" src="/cover_776-Eshelman.webp" style={{backgroundImage: 'url(/cover_776-Eshelman.webp)'}} />
                                    <aside>
                                        <hgroup>
                ...
                <article id="article--periodicals" className="article article--fullWidth">
                    <h3>Periodicals For Download</h3>
                        <figure className="card--book flex items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start ">
                                <Image width="207" height="267"alt="In The Continuum Phyllis Seckler" src="/cover_ITC-Seckler.webp"  style={{ backgroundImage: 'url(/cover_ITC-Seckler.webp)' }} />
                                <aside>
                                    <hgroup>
                                        <h4><strong>In the Continuum</strong> &#40;1973-1996&#41;</h4>
                                        <span>Phyllis Seckler &#40;Soror Meral&#41;</span>
                                    </hgroup>
                                    <strong>Download ITC</strong> <br/>
                                    <a href="http://www.limitlesslight.org/ITCarchive/ITCvol1.zip" target="_blank"><strong>Volume I:</strong> (1973-1977)</a><br/>
                                    <a href="http://www.limitlesslight.org/ITCarchive/ITCvol2.zip" target="_blank"><strong>Volume II:</strong> (1978-1981)</a><br/>
                                    <a href="http://www.limitlesslight.org/ITCarchive/ITCvol3.zip" target="_blank"><strong>Volume III:</strong> (1982-1986)</a><br/>
                                    <a href="http://www.limitlesslight.org/ITCarchive/ITCvol4.zip" target="_blank"><strong>Volume IV:</strong> (1987-1991)</a><br/>
                        ...
                        <figure className="card--book flex items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start order-1">
                                <Image width="207" height="267" alt="Black Pearl James A. Eshleman" src="/cover_BlackPearl-Eshelman.webp" style={{backgroundImage: 'url(/cover_BlackPearl-Eshelman.webp)'}} />
                                <aside>
                                    <hgroup>
                                        <h4><strong>Black Pearl</strong> &#40;1997-2002&#41;</h4>
                                        <span>James A. Eshelman</span>
                                    </hgroup>
                                    <strong>Download Black Pearl</strong> <br/>
                                    <a href="http://www.limitlesslight.org/BParchive/bp_volI_i-iv.zip" target="_blank">Issues 1-4</a><br />
                                    <a href="http://www.limitlesslight.org/BParchive/bp_volI_v-ix.zip" target="_blank">Issues 5-9</a><br />
                    ...
                    <ul className="list list--collection collection--4up">
                        <li className="card card--book">
                            <div className="wrapper-img wrapper-img--rect">
                                <Image width="207" height="267" alt="Ethics Of Thelema Aleister Crowley" src="/cover_Ethics-Crowley.webp" style={{backgroundImage: 'url(/cover_Ethics-Crowley.webp)'}} />
                            </div>
                            <cite><strong>The Ethics of Thelema</strong></cite><br />
                            <span>Aleister Crowley</span>
                        </li>
                        <li className="card card--book">
                            <div className="wrapper-img wrapper-img--rect">
                                <Image width="207" height="267" alt="Sidereal Mundane Astrology James A. Eshleman" src="/cover_SMA-Eshelman.webp" style={{backgroundImage: 'url(/cover_SMA-Eshelman.webp)'}} />
                            </div>
                            <cite><strong>Sidereal Mundane Astrology</strong> &#40;v8.0&#41;</cite><br />
                            <span>James A. Eshelman</span>
                        </li>
                        <li className="card card--book">
                            <div className="wrapper-img wrapper-img--rect">
                                <Image width="207" height="267" alt="Andromeda Sidereal Ephemeris of the 21st Century &#40;Outer Planets) James A. Eshleman Anna Kria King" src="/cover_Emphemeris-EshelmanKing.webp" style={{backgroundImage: 'url(/cover_Emphemeris-EshelmanKing.webp)'}} />
                            </div>
                            <cite><strong>Andromeda Sidereal Ephemeris of the 21st Century &#40;Outer Planets&#41;</strong></cite><br />
                            <span>Eshelman &amp; King</span>
                        </li>
                        <li className="card card--book">
                            <div className="wrapper-img wrapper-img--rect">
                                <Image width="207" height="267"  alt="Liber Theta: Tarot Symbolism & Divination James A. Eshleman" src="/cover_LiberTheta-Eshelman.webp" style={{backgroundImage: 'url(/cover_LiberTheta-Eshelman.webp)'}} />
                            </div>
                            <cite><strong>Liber Theta: Tarot Symbolism & Divination</strong>(v4.0)</cite><br />
                            <span>Frater ∏. &#40;James A. Eshelman&#41;</span>
                        </li>
                        <li className="card card--book">
                            <div className="wrapper-img wrapper-img--rect">
