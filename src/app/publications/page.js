...
export const metadata = {
    ...
    keywords: 'A∴A∴, Soror Meral, Phyllis Seckler, James A. Eshleman, In the Continuum, The Mystical and Magical System of the A∴A∴, 776 1/2, Visions & Voices, Pearls Of Wisdom, Black Pearl, Liber VII, thelema, thelemic temple, thelema website, temple of thelema, college of thelema',
    alternates: {
                ...
                <section>
                        ...
                        <figure className="card--book flex flex-col md:flex-row items-start gap-8 w-full py-8">
                            <div className="flex flex-col items-start md:order-1 w-full md:w-[220px]">
                                ...
                                <aside>
                                    ...
                                    <a title="Download Black Pearl Issues 1-4" href="/downloads/bp_set_01-04.pdf" target="_blank">Issues 1-4</a><br />
                                    <a title="Download Black Pearl Issues 5-9" href="/downloads/bp_set_05-09.pdf" target="_blank">Issues 5-9</a><br />
                                    <a title="Download Black Pearl Issues 10-11" href="/downloads/bp_set_10-11.pdf" target="_blank">Issues 10-11</a>
                                </aside>
                            </div>
                            <figcaption className="wrapper-text">
                    ...
                    <article id="article--authors" className="article article--fullWidth">
                        ...
                        <section className="wrapper wrapper-text wrapper-text--columns">
                            ...
                            <p>He is currently the Chancellor of the College of Thelema, from which he earned his M.A. in Skeptical Theurgy in 1992, and serves as the Prolocutor General of Temple of Thelema, which he co-founded in 1987 with Anna-Kria King and Phyllis Seckler &#40;Soror Meral&#41;. He was the editor of and a major contributor to the College&apos;s biannual journal, Black Pearl, throughout its six-year publication run from 1997 to 2002.</p>                        
