...
const AccountOfTheOrder = () => (
    <>
    <article id="article--AccountOfTheOrder" className="article article--fullWidth">
        <hgroup>
            <h2>An Account of The Order</h2>
            <em>
                sub figura XXXIII <br />
                First written in the language of his period by the Councillor Von Eckartshausen and now revised and rewritten in the Universal Cipher.<br/>
                A&there4;A&there4; Official publication in Class C<br/>
                Issued by Order:<br/>
                D.D.S. 7° = 4<br/>
                O.S.V. 6° = 5<br/>
                N.S.F. 5° = 6<br/>
        ...
        <section className="wrapper-text--columns">
            ...
            <p>But the inner truth has always been confided to him who in his day had the most capacity for illumination, and he became the sole guardian of the original Trust, as High Priest of the Sanctuary.</p>
            <p>When it became necessary that interior truths should be enfolded in exterior ceremony and symbol, on account of the real weakness of men who were not capable of hearing the Light of Light, then exterior worship began. It was, however, always the type or symbol of the interior, that is to say, the symbol of the true and Secret Sacrament.</p>
        ...
        <section className="wrapper-text--columns">
            ...
            <p>Yet, besides their secret holy work, they have from time to time decided upon political strategic action.</p>
            <p>Thus, when the earth was night utterly corrupt by reason of the Great Sorcery, the Brethren sent Mohammed to bring freedom to mankind by the sword.</p>
            <p>This being but partially a success, they raised up one Luther to teach freedom of thought. Yet this freedom soon turned into a heavier bondage than before.</p>
            <p>Then the Brethren delivered unto man the knowledge of nature, and the keys thereof; yet this also was prevented by the Great Sorcery. </p>
            <p>Then the Brethren delivered unto man the knowledge of nature, and the keys thereof; yet this also was prevented by the Great Sorcery. </p>
        ...
        <section className="wrapper-text--columns">
            ...
            <p>This school of wisdom has been for ever most secretly hidden from the world, because it is invisible and submissive solely to illuminated government.</p>
            <p>It has never been exposed to the accidents of time and to the weakness of man, because only the most capable were chosen for it, and those who selected made no error.</p>
            <p>Through this school were developed the germs of all the sublime sciences, which were first received by external schools, then clothed in other forms, and hence degenerated.</p>
            <p>According to time and circumstances, the society of sages communicated unto the exterior societies their symbolic hieroglyphs, in order to attract man to the great truths of their Sanctuary.</p>
        ...
        <section className="wrapper-text--columns">
            ...
            <p>This community has no outside barriers. He who may be chosen is as the first; he presents himself among the others without presumption, and he is received by the others without jealousy.</p>
            <p>If it be necessary that real members should meet together, they find and recognize each other with perfect certainty.</p>
            <p>No disguise can be used, neither hypocrisy nor dissimulation could hide the characteristic qualities which distinguish the members of this society. All illusion is gone, and things appear in their true form.</p>
