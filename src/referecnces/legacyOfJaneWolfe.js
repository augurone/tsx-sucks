...
const LegacyOfJaneWolfe = () => (
    ...
    <article id="article--LegacyOfJaneWolfe" className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>But, despite the exposition of Jane&apos;s life lovingly told by Soror Meral over some 30 issues of I.T.C., one still occasionally encounters misstatements about Jane, her work, and the A&#8756;A&#8756; legacy she left behind.</p>
