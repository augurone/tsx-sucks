...
const OneStarInSight = () => (
    <>
    <article id="article--OneStarInSight" className="article article--fullWidth article--fitContent">
        <hgroup>
            <h2>One Star In Sight</h2>
        ...
        <div className="flex flex-col">
            ...
            <p className="liberpoem">
                Thy Gods proved puppets of the priest.<br />
                &nbsp;&nbsp;&quot;Truth? All&apos;s relation!&quot; science sighed.<br />
                In bondage with thy brother beast,<br />
                &nbsp;&nbsp;Love tortured thee, as Love&apos;s hope died<br />
                And Love&apos;s faith rotted. Life no least<br />
                &nbsp;&nbsp;Dim star descried.
            </p>
            <p className="liberpoem">
                Thy cringing carrion cowered and crawled<br />
            ...
            <p className="liberpoem">
                All souls eternally exist,<br />
                &nbsp;&nbsp;Each individual, ultimate<br />
                Perfect &#8212; each makes itself a mist<br />
                &nbsp;&nbsp;Of mind and flesh to celebrate<br />
                With some twin mask their tender tryst<br />Insatiate.
            </p>
            <p className="liberpoem">
                Some drunkards, doting on the dream,<br />
                &nbsp;&nbsp;Despair that it should die, mistake<br />
                Themselves for their own shadow-scheme.<br />
                &nbsp;&nbsp;One star can summon them to wake<br />
                To self; star-souls serene that gleam<br />
                &nbsp;&nbsp;On life&apos;s calm lake.
            </p>
            <p className="liberpoem">
                That shall end never that began.<br />
                &nbsp;&nbsp;All things endure because they are.<br />
                Do what thou wilt, for every man<br />
                &nbsp;&nbsp;And every woman is a star.<br />
                Pan is not dead; he liveth, Pan!<br />
                &nbsp;&nbsp;Break down the bar!
            </p>
            <p className="liberpoem">
                To man I come, the number of<br />
                &nbsp;&nbsp;A man my number, Lion of Light;<br />
                I am The Beast whose Law is Love.<br />
                &nbsp;&nbsp;Love under will, his royal right &#8212;<br />
    ...
    <article id="article--OneStarInSightII" className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>&#40;These figures have special meanings to the initiated and are commonly employed to designate the grades.&#41;</p>
            <p>The general characteristics and attributions of these Grades are indicated by their correspondences on the Tree of Life, as may be studied in detail in the Book <em>777</em>.</p>
            <p><strong>Student</strong>. His business is to acquire a general intellectual knowledge of all systems of attainment, as declared in the prescribed books.</p>
            <p><strong>Probationer</strong>. His principal business is to begin such practices as he may prefer, and to write a careful record of the same for one year.</p>
            <p><strong>Neophyte</strong>. Has to acquire perfect control of the Astral Plane.</p>
            <p><strong>Zelator</strong>. His main work is to achieve complete success in Asana and Pranayama. He also begins to study the formula of the Rosy Cross.</p>
            <p><strong>Practicus</strong>. Is expected to complete his intellectual training, and in particular to study the Qabalah.</p>            
            <p><strong>Philosophus</strong>. Is expected to complete his moral training. He is tested in Devotion to the Order.</p>
            <p><strong>Dominus Liminis</strong>. Is expected to show mastery of Pratyahara and Dharana.</p>
            <p><strong>Adeptus</strong> &#40;without&#41;. Is expected to perform the Great Work and to attain the Knowledge and Conversation of the Holy Guardian Angel.</p>
            <p><strong>Adeptus</strong> &#40;within&#41;. Is admitted to the practice of the formula of the Rosy Cross on entering the College of the Holy Ghost.</p>
            <p><strong>Adeptus</strong> &#40;Major&#41;. Obtains a general mastery of practical Magick, though without comprehension.</p>
            <p><strong>Adeptus</strong> &#40;Exemptus&#41;. Completes in perfection all these matters. He then either &#40;a&#41; becomes a Brother of the Left Hand Path or, &#40;b&#41; is stripped of all his attainments and of himself as well, even of his Holy Guardian Angel, and becomes a Babe of the Abyss, who, having transcended the Reason, does nothing but grow in the womb of its mother. It then finds itself a &hellip;</p>
            <p><strong>Magister Templi</strong>. &#40;Master of the Temple&#41;: whose functions are fully described in <em>Liber 418</em>, as is this whole initiation from Adeptus Exemptus. See also <em>Aha!</em> His principal business is to tend his &quot;garden&quot; of disciples, and to obtain a perfect understanding of the Universe. He is a Master of Samadhi.</p>
            <p><strong>Magus</strong>. Attains to wisdom, declares his law &#40;See <em>Liber I vel Magi</em>&#41; and is a Master of all Magick in its greatest and highest sense.</p>
            <p><strong>Ipsissimus</strong>. Is beyond all this and beyond all comprehension of those of lower grades.</p>
            <p>But of these last three Grades see some further account in <em>The Temple of Solomon the King</em>, <em>The Equinox</em> I to X and elsewhere.</p>
            <p>It should be stated that these Grades are not necessarily attained fully, and in strict consecution, or manifested wholly on all planes. The subject is very difficult, and entirely beyond the limits of this small treatise.</p>
            <p>We append a more detailed account.</p>
        </section>
    </article>
    {/*-- Page 3 */}
    <article id="article--OneStarInSightIII" className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>Members of the Order are each entitled to found Orders dependent on themselves on the lines of the R.C. and G.D. orders, to cover types of emancipation and illumination not contemplated by the original (or main) system. All such orders must, however, be constituted in harmony with the A&there4;A&there4;. as regards the essential principles.</p>
            <p>All members of the Order are in possession of the Word of the existing Aeon, and govern themselves thereby.</p>
            <p>They are entitled to communicate directly with any and every member of the Order, as they may deem fitting.</p>
            <p>Every active Member of the Order has destroyed all that He is and all that He has on crossing the Abyss; but a star is cast forth in the Heavens to enlighten the Earth, so that he may possess a vehicle wherein he may communicate with mankind. The quality and position of this star, and its functions, are determined by the nature of the incarnations transcended by him.</p>
        </section>
    </article>
    <article id="article--OneStarInSightIV" className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>The Ipsissimus is pre-eminently the Master of all modes of existence; that is, his being is entirely free from internal or external necessity. His work is to destroy all tendencies to construct or to cancel such necessities. He is the Master of the Law of Unsubstantiality &#40;Anatta&#41;.</p>
            <p>The Ipsissimus has no relation as such with any Being: He has no will in any direction, and no Consciousness of any kind involving duality, for in Him all is accomplished; as it is written <em>&quot;beyond the Word and the Fool, yea, beyond the Word and the Fool.&quot;</em></p>
        </section>
    </article>
    <article id="article--OneStarInSightV" className="article article--fullWidth">
        ...
        <p>(Thus &quot;Suckling&quot; is the formula of an infant: when teeth appear it marks a new &quot;Aeon,&quot; whose &quot;Word&quot; is &quot;Eating.&quot;)</p>
        <p>A Magus can therefore only appear as such to the world at intervals of some centuries; accounts of historical Magi, and their Words, are given in <em>Liber Aleph</em>.</p>
        <p>This does not mean that only one man can attain this Grade in any one Aeon, so far as the Order is concerned. A man can make personal progress equivalent to that of a &quot;Word of an Aeon&quot;; but he will identify himself with the current word, and exert his will to establish it, lest he conflict with the work of the Magus who uttered the Word of the Aeon in which He is living.</p>
        <p>The Magus is pre-eminently the Master of Magick, that is, his will is entirely free from internal sectionersion or external opposition; His work is to create a new Universe in accordance with His Will. He is the Master of the Law of Change &#40;Anicca&#41;.</p>
        <p>To attain the Grade of Ipsissimus he must accomplish three tasks, destroying the Three Guardians mentioned in <em>Liber 418</em>, the 3rd Aethyr; Madness, and Falsehood, and Glamour, that is, Duality in Act, Word and Thought.</p>
        </section>
    </article>
    ...
    <article  id="article--OneStarInSightVIII"  className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>He will have attained all but the supreme summits of meditation, and should be already prepared to perceive that the only possible course for him is to devote himself utterly to helping his fellow creatures.</p>
    ...
    <article  id="article--OneStarInSightX"  className="article article--fullWidth">
     ...
     <article id="article--OneStarInSightSuccession" className="article article--fullWidth">
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>This rule has been relaxed, and a &quot;Grand Neophyte&quot; appointed to superintend all Members of the Order of the G.D. The real object of the rule was to prevent Members of the same Grade working together and so blurring each others individuality; also to prevent work developing into social intercourse.</p>
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>Each member must make it his main work to discover for himself his own true will, and to do it, and do nothing else.&#8225;</p>
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>There is no need to instruct a Babe thus born, for in the Abyss it was purified of every poison of personality; its ascent to the highest is assured, in its season, and it hath no need of seasons for it is conscious that all conditions are no more than forms of its fancy.</p>
            <p className="liberfootnote">Footnotes:<br /><em>**&nbsp;This book is published in the &quot;Equinox Vol. III No. 2.&quot;<br />**&nbsp;This is not in contradiction with the absolute right of every person to do his own true Will. But any True Will is of necessity in harmony with the facts of Existence; and to refuse to accept the Book of the Law is to create a conflict within nature, as if a physicist insisted on using an incorrect formula of mechanics as the basis of an experiment.<br /> &#8224;&nbsp;&quot;Their Will&quot; - not, of course, their wishes as individual human beings, but their will as officers of the New Aeon.<br /> &#8225;&nbsp;It is not considered &quot;essential to right conduct&quot; to be an active propagandist of the Law, and so on; it may, or may not, be the True Will of any particular person to do so. But since the fundamental purpose of the Order is to further the Attainment of humanity, membership implies, by definition, the Will to help mankind by the means best adapted thereto.</em></p>
        </section>
     </article>
     <article id="article--OneStarInSightConclude" className="article article--fullWidth">
        ...
        <p>In examination of physical practices, there is a standardised test. In Asana, for instance, the candidate must remain motionless for a given time, his success being gauged by poising on his head a cup filled with water to the brim; if he spill one drop, he is rejected.</p>
            ...
            <p>In the Qabalah, the candidate must discover for himself, and prove to the examiner beyond all doubt, the properties of a number never previously examined by any student.</p>  
            <p>In invocation the sectionine force must be made as manifest and unmistakable as the effects of chloroform; in evocation, the spirit called forth must be at least as visible and tangible as the heaviest vapours; in sectionination, the answer must be as precise as a scientific thesis, and as accurate as an audit; in meditation, the results must read like a specialist&apos;s report of a classical case.</p>
        ...
        <section className="wrapper-text wrapper-text--columns">
            ...
            <p>This paper has been written not only with the object of attracting individual seekers into the way of Truth, but of affirming the propriety of the methods of the A&there4;A&there4; as the basis for the next great step in the advance of human knowledge.</p>
            <p>Love is the law, love under will.</p>
            <p>O.M. 7=4 A&there4;A&there4;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Praemonstrator of the Order of the R&hellip; C&hellip;<br /><em>Given from the Collegium ad Spiritum Sanctum, Cefalu, Sicily, in the Seventeenth Year of the Aeon of Horus, the Sun being in 23&deg; Virgo and the Moon in 14&deg; Pisces. </em></p>
            <p className="liberfootnote">Footnote:<br /><em>*&nbsp;The natural talents of individuals differ very widely. The late Sir Richard Jebb, one of the greatest classical scholars of modern times, was so inferior to the average mediocrity in mathematics, that despite repeated efforts he could not pass the &quot;little go&quot; at Cambridge - which the dullest of minds can usually do. He was so deeply esteemed for his classics that a special &quot;Grace&quot; was placeted so as to admit him to matriculation. Similarly a brilliant Exorcist might be an incompetent sectioniner. In such a case the A&there4;A&there4; would refuse to swerve from Its system; the Aspirant would be compelled to remain at the Barrier until he succeeded in breaking it down, though a new incarnation were necessary to permit him to do so. But no technical failure of any kind soever could necessarily prevent him from accomplishing the Two Critical Tasks, since the fact of his incarnation itself proves that he has taken the Oath which entitled him to attain to the Knowledge and Conversation of his Holy Guardian Angel, and the annihilation of this Ego. One might therefore be an Adeptus Minor or even a Magister Templi, in essence, though refused official recognition by the A&there4;A&there4; as a Zelator owing to (say) a nervous defect which prevented him from acquiring a Posture which was &quot;steady and easy&quot; as required by the Task of that grade.</em></p>
        </section>
     </article>
